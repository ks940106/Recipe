	...
	<div class="container_etc" style="width: 490px;">
		<div class="panel panel-default">
			<div class="panel-body">
				<form name="joinFrm" method="post" action="/user/insert.html">
					<input type="hidden" name="token" value="12144132"> <input
				...
				<textarea>만개의레시피 이용약관은 다음과 같은 내용을 담고 있습니다. (2019년 3월 7일 시행)
제1조(목적)
...
3. 본 약관 시행 전에 이미 가입된 회원은 변경 전의 약관이 적용됨을 원칙으로 합니다. 다만, 공지된 바에 따라 변경된 약관의 시행일 이후에도 본 약관에 따른 서비스를 계속 이용하는 경우에는 변경 후의 약관에 대해 동의한 것으로 봅니다.
				...
				<textarea>(주)이지에이치엘디(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 회사의 서비스를 이용하는 회원(이하 ‘이용자’라 한다) 의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립·공개합니다.
1. 총칙
...
- 소속 : 기획팀
- 성명 : 이창득
- E-mail : forpromi74@10000recipe.com
- 전화번호 : 02-323-5002
- FAX : 02-323-5049
나) 개인정보 관리담당자
- 소속 : 기획팀
- 성명 : 전효민
- E-mail : jhmonster@10000recipe.com
- 전화번호 : 02-323-5002
- FAX : 02-323-5049
제18조 광고성 정보전송
...
- &lt;a href="/user/rules.html?f=privacy_20171126" style="color:#0000FF;text-decoration:underline;"&gt;2017년 11월 26일~2019년 3월 6일 적용 보기&lt;/a&gt;
- &lt;a href="/user/rules.html?f=privacy_20150601" style="color:#0000FF;text-decoration:underline;"&gt;2015년 6월 1일~2017년 11월 25일 적용 보기&lt;/a&gt;</textarea>
			</div>
		</div>
		<p id="checkMsg"
		...
		<p style="text-align: center;">
			<button type="button" onclick="doAgreeCheckCamping()"
