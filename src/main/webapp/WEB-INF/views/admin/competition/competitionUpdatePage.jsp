...
<body>
	...
	<section>
      ...
      <form action="/competitionUpdate.do" method="post" enctype="multipart/form-data">
            <table class="table">
               ...
               <tr>
                  <th>제목</th>
                  <td><input type="text" class="form-control" name="competitionTitle" value="${competition.competitionTitle }"></td>
               </tr>
               <tr>               
                  <th>대회 진행 여부</th>
                  <td>
               ...
               <tr>
                  <th>내용</th>
                  <td><textarea name="competitionContents" class="form-control" rows="3">${competition.competitionContents }</textarea> </td>
