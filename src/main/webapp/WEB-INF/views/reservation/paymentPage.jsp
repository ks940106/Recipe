            ...
            <div class="section_content_nav">
                <div class="cp_content">
                	<form action="/payment.do" onsubmit="return sbm2()">
                		...
                		<div style="border:1px solid lightgray;text-align: left;">
                		...
                		<div style="border:1px solid lightgray;text-align: left;">
						'싱싱캠핑'은 (이하 '회사'는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.<br>
						...
						&nbsp;- 이용자의 경우<br>
						&nbsp;&nbsp;1) 개인정보를 제공받는 자 : 이용하고자 하는 해당 숙박업소. 싱싱캠핑<br>
                		...
                		<input id="phone2" class="form-control" style="display:inline;width:23%;" maxlength="4" numberOnly> &nbsp;-&nbsp;  
                		<input id="phone3" class="form-control" style="display:inline;width:23%;" maxlength="4" numberOnly><br>
                		<span style="color:#ea1f62">예약 관련 연락을 받을 번호를 입력해주세요.</span>
                		<br><br>
                		이메일 <br>
                		<input id="email1" class="form-control" style="display:inline;width:36%;"> @ 
                		<input id="email2" class="form-control" style="display:inline;width:33%;" value="이메일을 선택해주세요." readonly>
                		<select id="email3" class="form-control" style="display:inline;width:6%;">
